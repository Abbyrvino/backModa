...
public class NotaVentaService {
    ...
    public List<VentaResumen> obtenerVentasPorFechas(LocalDateTime fechaInicio, LocalDateTime fechaFin) {
        return notaVentaRepository.obtenerVentasPorFechas(fechaInicio, fechaFin);
    }
