...
import com.si.apirest.model.dto.VentaResumen;
...
public interface NotaVentaRepository extends JpaRepository<NotaVenta, Integer>{
    ...
    @Query(value = "CALL ObtenerVentasPorFechas(:fechaInicio, :fechaFin)", nativeQuery = true)
    List<VentaResumen> obtenerVentasPorFechas(@Param("fechaInicio") LocalDateTime fechaInicio, @Param("fechaFin") LocalDateTime fechaFin);
